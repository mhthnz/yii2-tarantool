...
use mhthnz\tarantool\tests\classes\ActionRule;
use mhthnz\tarantool\tests\classes\AuthorRule;
 ...
 * ManagerTestCase.
 */
abstract class ManagerTestCase extends \mhthnz\tarantool\tests\TestCase
{
    /**
    ...
    public function testAssignRule($RBACItemType)
    {
        ...
        // using DI
        \Yii::$container->set('write_rule', ['class' => ActionRule::class, 'action' => 'write']);
        \Yii::$container->set('delete_rule', ['class' => ActionRule::class, 'action' => 'delete']);
        \Yii::$container->set('all_rule', ['class' => ActionRule::class, 'action' => 'all']);
