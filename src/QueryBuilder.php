...
class QueryBuilder extends \yii\db\QueryBuilder
{
     ...
     */
    public function insertOrReplace($table, $columns, &$params, $loadSchema = true)
    {
        list($names, $placeholders, $values, $params) = $loadSchema ? $this->prepareInsertValues($table, $columns, $params) : $this->prepareInsertValuesWithoutSchemaLoad($table, $columns, $params);
     ...
     * @since 2.0.14
     */
    protected function prepareInsertValuesWithoutSchemaLoad($table, $columns, $params = [])
    {
